...
<title>Learning Management System Project</title>
<!-- Favicon-->
...
<body id="page-top">
	...
	<nav
		...
		id="mainNav">
		<div class="container">
			<a class="navbar-brand" href="#page-top">LMS Project</a>
			<button
	...
	<header class="masthead bg-primary text-white text-center">
		<div class="container d-flex align-items-center flex-column">
			...
			<!-- Masthead Subheading-->
			<p class="masthead-subheading font-weight-light mb-0">A Teacher and Student Personal Platform.</p>
		</div>
	</header>
	<!-- Portfolio Section-->
			...
			<div class="row justify-content-center">
				...
				<div class="col-md-6 col-lg-4 mb-5">
					<div class="portfolio-item mx-auto" data-bs-toggle="modal"
						...
						<img class="img-fluid" src="images/access.png"
							alt="..." />
					</div>
				</div>
				<!-- Portfolio Item 3-->
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-4 ms-auto">
					<p class="lead">Our platform is an free learning platform where students can access large number of libraries of study materials and assessment.</p>
				</div>
				<div class="col-lg-4 me-auto">
					<p class="lead">Teachers have access for creating classes for their students and provide study materials easily to them or take their test.</p>
				</div>
			</div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-4 mb-5 mb-lg-0">
					...
					<p class="lead mb-0">
						Techno International Batanagar<br /> Kolkata-700141
					</p>
				</div>
				<!-- Footer Social Icons-->
				<div class="col-lg-4 mb-5 mb-lg-0">
				...
				<!-- Footer About Text-->
				<div class="col-lg-4">
					<h4 class="text-uppercase mb-4">About LMS</h4>
					<p class="lead mb-0">
					LMS project is an project of Techno International Batanagar by Nishant.	 <a href="http://startbootstrap.com">Start Bootstrap</a> .
					</p>
				</div>
			</div>
		</div>
