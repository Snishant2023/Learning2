...
<%
    ...
    if(request.getParameter("submit")!=null)
    {
        ...
        pst = con.prepareStatement("insert into users(stname,course,fee)values(?,?,?)");
            ...
            <div class="col-sm-4">
                <form  method="POST" action="#" >
                    ...
                    <div alight="left">
                        ...
                        <input type="text" class="form-control" placeholder="Teacher Name" name="sname" id="sname" required >
                     </div>
                     ...
                     <table id="tbl-student" class="table table-responsive table-bordered" cellpadding ="0" width="100%">
                         <thead>
                             ...
                             <tr>
                                 ...
                                 <td><a href="studentPay.jsp?id=<%=id%>">Delete</a></td>
                             </tr>
